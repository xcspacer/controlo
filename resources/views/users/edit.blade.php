                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="mt-4">
                            <label for="is_admin" class="inline-flex items-center">
                                <input id="is_admin" type="checkbox" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:bg-gray-700 dark:ring-offset-gray-800" name="is_admin" {{ $user->is_admin ? 'checked' : '' }}>
